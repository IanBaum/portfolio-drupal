 ...
 */
function ibzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['ibzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('ibzen sample setting'),
  '#default_value' => theme_get_setting('ibzen_example'),
